...
- Colab-ready sample codes of image processing
  ...
  - AI tech changes so fast that the demos lose compatibility within a few months.
...
[CNN Explainer](https://poloclub.github.io/cnn-explainer/) ([GitHub](https://github.com/poloclub/cnn-explainer), [arXiv](https://arxiv.org/abs/2004.15004))

### CNN Architectures
- Image recognition: image to label ([AlexNet, VGG, ResNet, etc.](https://medium.com/zylapp/review-of-deep-learning-algorithms-for-image-classification-5fdbca4a05e2), [survey](https://arxiv.org/abs/1809.02165), <s>[OpenAI Microscope](https://microscope.openai.com/models))</s>
